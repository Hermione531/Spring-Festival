<template>
  <div class="background background-full  theme-bg">
      ...
      <div v-if="complete" class="background-full theme-bg__tooltip1"></div>
      <div class="theme-redpocket">
        <div class="background-full amin-rotate theme-redpocket__bg theme-redpocket__bg0"></div>
        <div class="background-full amin-rotate__delay theme-redpocket__bg theme-redpocket__bg1"></div>
        <div class="background-full amin-rotate  theme-redpocket__bg theme-redpocket__bg2"></div>
        <div class="background-full amin-rotate__delay theme-redpocket__bg theme-redpocket__bg3"></div>
        <div class="background-full amin-rotate theme-redpocket__bg theme-redpocket__bg4"></div>
        <div class="background-full amin-rotate__delay theme-redpocket__bg theme-redpocket__bg5"></div>
        <div class="background-full amin-rotate__delay theme-redpocket__bg theme-redpocket__bg6"></div>
      </div>
